...
{
    Node structure1, structure2;
    int corridorWidth, modifierDistanceFromWall=1;
    ...
    {
        var relativePositionOfStructure2 = CheckPositionOfStructure2AgainstStructure1();
    ...
    {
        Node bottomStructure=null, topStructure=null;
    ...
    int GetValidXForNeighbourUpDown(Vector2Int bottomNodeLeft, Vector2Int bottomNodeRight, Vector2Int topNodeLeft, Vector2Int topNodeRight)
    {
    ...
    {
        Node leftStructure=null, rightStructure=null;
        ...
        {
            sortedLeftStructure = sortedLeftStructure.Where(child=>TopLeftAreaCorner.y != leftStructure.TopLeftAreaCorner.y).ToList();
    ...
    int GetValidYForNeighbourLeftRight(Vector2Int leftNodeUp, Vector2Int leftNodeDown, Vector2Int rightNodeUp, Vector2Int rightNodeDown)
    {
        ...
        if(leftNodeUp.y>=rightNodeDown.y && leftNodeUp.y<=leftNodeUp.y)
        {
            return StructureHelper.CalculateMiddlePoint
            (
                rightNodeDown + new Vector2Int(0, modifierDistanceFromWall),
        ...
        if(leftNodeDown.y>=rightNodeDown.y && leftNodeDown.y<=leftNodeUp.y)
        {
            return StructureHelper.CalculateMiddlePoint
            (
                leftNodeDown + new Vector2Int(0, modifierDistanceFromWall),
    ...
    RelativePosition CheckPositionOfStructure2AgainstStructure1()
    {
